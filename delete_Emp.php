...
.topnav a.active {
  ...
  <a href="view_employees.php">View Employee</a>
        ...
        <center><h2>Deleting Employee</h2><br><br>
<form action="del_Emp.php" style="width:30%; margin-left:10px; border: 2px solid black;">
	<label>Employee ID</label><br>
	<input name="empID" class="form-control"><br>
	<label>Employee Name</label><br>
	<input name="empName" class="form-control"><br><br>
	<input type="submit" name="submit" value="submit">

		<a href="employee.php"><input type="button" style="margin-left:10px;" class="btn btn-primary" name="back" value="Back"></a>
